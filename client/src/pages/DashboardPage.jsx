...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 w-full max-w-full overflow-x-hidden">
      ...
      <main className="max-w-[1440px] mx-auto px-4 sm:px-6 py-6 sm:py-8 w-full">
        {/* Page Header */}
        <div className="mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <section className="lg:col-span-8 min-w-0">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              {/* Header with toggle */}
              <div className="px-4 sm:px-6 py-4 border-b border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-slate-50/50">
                <div className="flex items-center gap-2">
                ...
                <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 w-full sm:w-auto">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 bg-amber-500 hover:bg-amber-600 text-white text-xs font-semibold px-3.5 py-2 rounded-lg transition-colors shrink-0 whitespace-nowrap"
                  >
                    <Plus className="w-3.5 h-3.5 shrink-0" />
                    <span>Add {activeView === 'students' ? 'Student' : 'Teacher'}</span>
                  </button>
                </div>
              </div>
